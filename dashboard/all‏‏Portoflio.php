                ...
                <?php foreach($data as $da):    ?>
                  <tr>
                   <td>
                    ...
                    <td> <img src="upload/<?=  $da['img'];  ?>" alt="img" style="height:100px;width:200px"> </td>
                    <td><?php echo $da['sname']; ?></td>
                    <td><a class="btn btn-primary" href="‏Update‏Portoflio.php?proid=<?= $da['id']; ?>">Update</a></td>
                    <td><a class="btn btn-warning" href="deleteportflio.php?proid=<?php echo $da['id']; ?>">Delete</a></td>
                  </tr>
                 <?php  endforeach    ?>
                  </tbody>
                  <tfoot>
