...
//     //insert in db
$res=updateportflio($pro_id,$filename,$desc);
if($res==true){
  header('LOCATION:all‏‏Portoflio.php');
}else{
  $error='project not inserted data  ';
}
}

else{
  $pro_id=$_GET['proid'];
$data=GetPortofliDatabyId($pro_id);
}
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- <a href="index3.html" class="brand-link">
      <img src="backassets/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Portoflio.php" class="nav-link active">
              ...
              <li class="nav-item">
              <a href="all‏‏Portoflio.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>AllPortFlio</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <?php if(isset($sucess) or isset($error)) : ?>
<div class="alert <?php if(isset($sucess)): ?>alert-success <?php else: ?>alert-danger <?php endif; ?>  alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <h5><i class="icon fas fa-ban"></i> Alert!</h5>
                 <ul>
                   <li><?php echo (isset($sucess)) ? $sucess : $error ?></li>
                </ul>
                </div>
...
<?php endif; ?>
        ...
        <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="‏Update‏Portoflio.php" method="post" enctype="multipart/form-data"> 
                <div class="card-body">
                  <div class="form-group">
                  <label for="exampleInputFile">Desc</label>
                  <textarea class="form-control textarea" name="desc"><?= $data['description']; ?></textarea>
                  </div>
                 <img src="upload/<?php echo $data['img']; ?>" width="140px;" />
                  <div class="form-group">
                    ...
                    <input type="hidden" name="prolab_id" value="<?= $pro_id ?>" >
                    </div>
                  </div>
...
<script src="backassets//jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
